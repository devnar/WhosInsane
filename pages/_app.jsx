...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/EGzmx574qv",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=1155936471505707069&scope=bot",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/1155936471505707069/vote",
    },
    {
      link: true,
      name: "Partners",
